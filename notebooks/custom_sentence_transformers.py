...
class CustomSentenceTransformer(SentenceTransformer):
    ...
    def fit(self,
        ...
        :param gradient_accumulation_steps: Number of steps to accumulate before performing a backward pass
        ...
        for epoch in trange(epochs, desc="Epoch", disable=not show_progress_bar):
            ...
            for i, _ in enumerate(trange(steps_per_epoch, desc="Iteration", smoothing=0.05, disable=not show_progress_bar)):
                for train_idx in range(num_train_objectives):
                    ...
                    if not skip_scheduler and (i + 1) % gradient_accumulation_steps == 0:
                        scheduler.step()
